...
namespace collectIO.Services.Migrations
{
    ...
    [Migration("20220515171302__likes_again")]
    partial class _likes_again
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("collectIO.Models.Like", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("collectIO.Models.Like", b =>
                {
                    b.HasOne("collectIO.Models.Item", "Item")
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("collectIO.Models.AppUser", "User")
                        .WithMany()
